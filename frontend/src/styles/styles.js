const styles = {
    ...
    button: 'w-[150px] bg-[#84cc16] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    sendMsgbutton: 'w-[150px] bg-[#3d3a3a] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',  //($)
    sellerbutton: 'w-[140px] bg-[#3d3a3a] h-[40px] my-3 flex items-center justify-center rounded-full cursor-pointer', //($)
